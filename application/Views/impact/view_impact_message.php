...
<body>
	...
	<div class="row">
		<div class="col-lg-12">
      <?php echo form_open('impact/delete'); ?>
				...
				<div class="panel-body">
                  ...
                  <?php foreach($impact as $item){?>
     							<label><?=lang('impact.impact_name')?> : </label>
     							<?php echo $item->impact_name;?>
							</div>

              <div class="form-group">
     							<label><?=lang('impact.impact_value')?> : </label>
     							<?php echo $item->impact_value;?>
							</div>
