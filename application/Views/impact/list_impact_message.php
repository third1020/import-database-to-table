<link href="<?=base_url('assets')?>/vendor/datatables-plugins/dataTables.bootstrap.css"
	rel="stylesheet">
<form action="<?php echo base_url();?>index.php/impact/delete" method="post"></form>
<form action="<?php echo base_url();?>index.php/impact/update" method="post"></form>
...
<div class="row">
	<div class="col-lg-12">
		<h3 class="page-header"><?=lang('impact.pageHeader')?></h3>
		<!-- 		<div class=""> -->
		<div class="panel-body">


			<div class="panel panel-default">
				<div class="panel-heading"><?=lang('impact.pageHeaderTable') ?></div>
				<!-- /.panel-heading -->
				<div class="panel-body">
					<table width="100%" class="table table-striped table-bordered table-hover"
						...
						<thead>
							<tr>
								<th><?=lang('impact.id')?></th>
								<th><?=lang('impact.impact_name')?></th>
								<th><?=lang('impact.impact_value')?></th>
...
$(document).ready(function() {
	...
	var table = $('#dataTables-example').DataTable( {
	    ...
	    "bSort":false,
	    "ajax": {
	    	      url: "<?=site_url('impact/dataProcessing')?>",
            	type: "POST",
            	pages: 5,
							ajax: "data.json"
		    },
	    "columns": [
	        {  name: "id",data: "id" },
	        {  name: "impact_name",data: "impact_name" },
	        {  name: "impact_value",data: "impact_value" },
 ...
 // }, 1000 );
	...
	$('#dataTables-example tbody').on( 'click', 'button', function () {
        ...
        if($(this).val() == 'update')  {
        		...
        		var frameSrc = "<?php echo base_url('index.php/impact/updateForm/');?>"+rowData['id'];
...
// 		console.log($(this).val());
	...
	var rowData = $('#dataTables-example').DataTable().row($tr).data();
	if($(this).val() == 'delete')  {
		var frameSrc = "<?php echo base_url('index.php/impact/deleteForm/');?>"+rowData['id'];
