...
<!-- /.row -->
<div class="row">
	<?php echo form_open("Petition/Incident_confirm/$incident->id"); ?>
		...
		<div class="panel-body">
			<div class="row">
				<div class="col-lg-12">
					...
					<?php if($incident->incident_status != 0) { ?>
					<div class="form-group">
						<label style="color: red">The item has been updated.</label>
					</div>
					<?php } else { ?>
					<div class="form-group">
						<label>Status</label> <select name="incident_status" class="form-control">
