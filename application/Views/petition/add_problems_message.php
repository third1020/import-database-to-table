...
<?php endif ?>
<?php echo form_open('Petition/Problems'); ?>
<div class="row">
	<div class="col-lg-12">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="form-group">
							...
							<input name="problems_tital" class="form-control"
								placeholder="Enter text" value="<?=isset($input['problems_tital']) ? $input['problems_tital'] : '' ?>">
						</div>
						<label><?=lang('request.request_detail')?></label></br>
						<textarea id="froala-editor" name="problems_detail">
							<?=isset($input['problems_detail']) ? $input['problems_detail'] : '' ?>
						</textarea>
						<br>
					</div>
					<!-- /.col-lg-6 (nested) -->
...
$('select[name=equipment_id] option[value=<?=isset($input['problems_detail']) ? $input['problems_detail'] : '' ?>]').attr('selected','selected');
</script>
