<link href="<?=base_url('assets')?>/vendor/datatables-plugins/dataTables.bootstrap.css"
	rel="stylesheet">
<form action="<?php echo base_url();?>index.php/contact/delete" method="post"></form>
<form action="<?php echo base_url();?>index.php/contact/update" method="post"></form>
...
<div class="row">
	<div class="col-lg-12">
		<h3 class="page-header"><?=lang('contact.pageHeader')?></h3>
		<!-- 		<div class=""> -->
		<div class="panel-body">


			<div class="panel panel-default">
				<div class="panel-heading"><?=lang('contact.pageHeaderTable') ?></div>
				<!-- /.panel-heading -->
				<div class="panel-body">
					<table width="100%" class="table table-striped table-bordered table-hover"
						...
						<thead>
							<tr>
								...
								<th><?=lang('contact.contact_phone')?></th>
								<th><?=lang('contact.contact_email')?></th>
								<th><?=lang('contact.contact_address')?></th>
								<th><?=lang('contact.contact_detail')?></th>
...
$(document).ready(function() {
	...
	var table = $('#dataTables-example').DataTable( {
	    ...
	    "bSort":false,
	    "ajax": {
	    	      url: "<?=site_url('contact/listProcessing')?>",
            	type: "POST",
            	pages: 5,
							ajax: "data.json"
		    },
	    "columns": [
	        ...
	        {  name: "contact_phone",data: "contact_phone" },
	        {  name: "contact_email",data: "contact_email" },
	        {  name: "contact_address",data: "contact_address" },
					{  name: "contact_detail",data: "contact_detail" },
 ...
 // }, 1000 );
	...
	$('#dataTables-example tbody').on( 'click', 'button', function () {
        ...
        if($(this).val() == 'update')  {
        		...
        		var frameSrc = "<?php echo base_url('index.php/contact/updateForm/');?>"+rowData['id'];
...
// 		console.log($(this).val());
	...
	var rowData = $('#dataTables-example').DataTable().row($tr).data();
	if($(this).val() == 'delete')  {
		var frameSrc = "<?php echo base_url('index.php/contact/deleteForm/');?>"+rowData['id'];
