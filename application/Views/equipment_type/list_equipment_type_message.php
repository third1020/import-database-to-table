...
<div class="row">
	<div class="col-lg-12">
		<h3 class="page-header"><?=lang('equipment.pageHeader_equipment_type_list')?></h3>
		<!-- 		<div class=""> -->
		<div class="panel-body">
			<div class="panel panel-default">
				<div class="panel-heading"><?=lang('equipment.pageHeaderTable_list') ?></div>
				<!-- /.panel-heading -->
				<div class="panel-body">
...
$(document).ready(function() {
	...
	var table = $('#dataTables-example').DataTable( {
	    ...
	    "bSort":false,
	    "ajax": {
	    	      url: "<?=site_url('EquipmentType/ListProcessing')?>",
            	type: "POST",
            	pages: 5,
							ajax: "data.json"
		    },
 ...
 // }, 1000 );
	...
	$('#dataTables-example tbody').on( 'click', 'button', function () {
        ...
        if($(this).val() == 'update')  {
        		...
        		var frameSrc = "<?php echo base_url('index.php/');?>/EquipmentType/updateForm/"+rowData['id'];
