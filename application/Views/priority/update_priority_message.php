...
<body>
    ...
    <?php endif ?>
                     	<?php echo form_open('priority/UpdateProcess'); ?>
                         <div class="panel panel-default">
     		<div class="panel-heading"><?=lang('priority.priority_edit')?></div>
     			<div class="panel-body">
     				<div class="row">
     					<div class="col-lg-6">

     						<div class="form-group">
     							<label><?=lang('priority.priority_name')?></label> <input name="priority_name"
     								class="form-control" placeholder="Enter text" value="<?php echo $priority->priority_name;?>">
     						</div>
      ...
      <label>
        <input type="checkbox" class="radio" value="3" name="priority_status" ><?=lang('priority.value_hight')?></label>
         ...
         <button type="submit"  name="id" value="<?php echo $priority->id;?>" class="btn btn-default" ><?=lang('content.bt_submit')?></button>
