...
<body>
	...
	<div class="row">
		<div class="col-lg-12">
      <?php echo form_open('priority/delete'); ?>
					...
					<div class="row">
						<div class="col-lg-6">
							<div class="form-group">
     							...
     							<label><?=lang('priority.priority_name')?> : </label>
     							<?php echo $priority->priority_name;?>
							</div>

              <div class="form-group">
     							<label><?=lang('priority.priority_status')?> : </label>
     							<?php echo $priority->priority_status;?>
							</div>
         ...
         <button type="submit" onclick="window.parent.closeModaldelete();"  name="id" value="<?php echo $priority->id;?>" class="btn-danger" &times;><?=lang('content.bt_delete')?></button>
