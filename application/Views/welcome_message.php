...
<script src="<?=base_url('assets')?>/vendor/bootstrap/js/bootstrap-datetimepicker.min.js"></script>
...
<link href="<?=base_url('assets')?>/vendor/bootstrap/css/bootstrap-datetimepicker.min.css" rel="stylesheet">
<!-- MetisMenu CSS -->
