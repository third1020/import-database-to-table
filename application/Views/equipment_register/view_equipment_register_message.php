...
<body>
	...
	<div class="row">
		<div class="col-lg-12">
      <?php echo form_open('EquipmentRegister/delete'); ?>
              ...
              <div class="form-group">
                <label><?=lang('equipment.department')?> : </label>
                <?php echo $item->department;?>
              </div>

              <div class="form-group">
                <label><?=lang('equipment.username')?> : </label>
                <?php echo $item->username;?>
              </div>

							<div class="form-group">
								<label><?=lang('equipment.history')?> : </label>
								<?php echo $item->history;?>
							</div>

              <div class="form-group">
                <label><?=lang('equipment.equipment_register_type')?> : </label>
                <?php echo $item->equipment_type;?>
              </div>
